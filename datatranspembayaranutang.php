...
<head>
    ...
    <title>Data Transaksi Pembayaran Utang</title>
...
<body>
    <div class="mt-3 border p-3 text-wrap">
        ...
        <?php
            include "koneksi.php";
            $no = 1;
            $query = mysqli_query($mysqli, 'SELECT * FROM tb_pembelian');
        ...
        <tr>
            <td colspan="4" style="text-align: left; font-size: 17px; color: maroon;">Total Pengeluaran Utang :</td>
